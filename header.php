        ...
        <a class="navbar-brand" id="logo" href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title() ?></a>
			...
			<div class="navbar-collapse collapse navbar-responsive-collapse">
			    <ul class="nav navbar-nav">
						<li class="site-logo"><a class="navbar-brand" href="//bangz.me"><img src="<?php $this->options->themeUrl("img/logo-min.png"); ?>"></a></li>
			    	<li<?php if($this->is('index')): ?> class="active"<?php endif; ?>><a href="<?php $this->options->siteUrl(); ?>"><i class="fa fa-home" aria-hidden="true"></i> 首 页 </a></li>
